  ...
  if (isStarted) {
    return (
      <SurveyShell
        ...
        surveyLabel="Stakeholder Assessment Survey"
      />
    );
  }
      ...
      <main className="flex-grow relative z-10">
        ...
        <section className="pt-12 pb-10 px-6 max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-base md:text-lg text-[#4A5568] leading-relaxed mb-10 max-w-2xl mx-auto">
              Evaluating the inclusion, access, and digital services of the Barbados Trident Digital Identity to ensure it is trusted and rights-respecting.
            </p>

            {/* Quick Briefing Cards (Stakeholder Specific) */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10 max-w-3xl mx-auto text-left">
              <div className="bg-white p-4 rounded-xl border border-[#DDE1E9] shadow-sm">
                <div className="font-bold text-sm text-[#0D1117] mb-1">Core Focus</div>
                <div className="text-xs text-[#4A5568]">Evaluate inclusion, privacy, and service value.</div>
              </div>
              <div className="bg-white p-4 rounded-xl border border-[#DDE1E9] shadow-sm">
        ...
        <section className="px-6 pb-20 max-w-6xl mx-auto border-t border-[#DDE1E9] pt-12">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-[#4A5568] mt-2">The assessment spans the following dimensions:</p>
          </div>
